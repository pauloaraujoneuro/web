...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-bg via-bg to-secondary/30">
      <section className="container-shell px-6 py-10 sm:px-8 sm:py-12 lg:px-12">
        <div className="grid min-h-[calc(100dvh-var(--anchor-offset))] place-items-center">
          <div className="card-surface relative w-full max-w-2xl overflow-hidden p-8 sm:p-12">
